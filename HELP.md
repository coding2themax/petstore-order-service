...
* The original package name 'com.coding2.the.max.petstore-order-service' is invalid and this project uses 'com.coding2.the.max.petstore_order_service' instead.
